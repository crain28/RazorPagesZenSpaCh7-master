...
namespace RazorPages.Migrations
{
    ...
    [Migration("20201021181558_DataAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 21, 14, 15, 57, 221, DateTimeKind.Local).AddTicks(5434),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2020, 10, 21, 14, 15, 57, 230, DateTimeKind.Local).AddTicks(5822),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 21, 14, 15, 57, 230, DateTimeKind.Local).AddTicks(5947),
                            ServicesID = 5
                        });
                });
