    ...
    public partial class DataAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ID", "Address", "City", "ConfirmPassword", "Country", "Email", "First Name", "First Name", "Password", "Phone", "Zipcode", "State", "Username" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2020, 10, 21, 14, 15, 57, 221, DateTimeKind.Local).AddTicks(5434), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2020, 10, 21, 14, 15, 57, 230, DateTimeKind.Local).AddTicks(5947), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2020, 10, 21, 14, 15, 57, 230, DateTimeKind.Local).AddTicks(5822), 7 });
